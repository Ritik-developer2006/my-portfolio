                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/file-upload" class="dropzone dz-component" id="file-manager-upload">
                                        <div class="dz-default dz-message"><button class="dz-button" type="button"><i class="fa-solid fa-cloud-arrow-down"></i><span>Drop a file here or click to upload</span></button></div>
                                    </form>
                                </div>
                            </div>
                        </div>
